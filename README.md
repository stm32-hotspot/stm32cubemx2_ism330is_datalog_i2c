...
```text
[INFO] Step 1: ISM330IS sensor init completed
...
- Part ism330is.c/.h
- Part ism330is/interfaces/i2c/ism330is_io.c/.h


In this example, the ISM330IS component is configured through the I2C IO operations defined under the folder interfaces/i2c.
Once the I2C is initialized, the ISM330IS can be initialized too through the call of ism330is_drv_init() API.
...
- Select the appropriate IoC2 file based on the combination of NUCLEO and X-NUCLEO boards. For example, use c562re_iks5a1_ism330is_datalog_i2c.ioc2 for NUCLEO-C562RE and X-NUCLEO-IKS5A1.
